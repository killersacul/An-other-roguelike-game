...
class Consumable(BaseComponent):
    ...
    def get_actions(self, consumer: Actor) -> Optional[actions.Action]:
        """Try to return the actions for this item."""
...
class LightningDamageConsumable(Consumable):
    ...
    def activate(self, action: actions.ItemAction) -> None:
        ...
        if target:
            self.engine.message_log.add_message(
                f"A lighting boolt strikes the {target.name} with a loud thunder, for {self.damage} damage!"
            )
